...
/***************************** Created by MontyKhanna ****************************************/        

/*
 * Private var
 * 
 */
        private $__window_load = "";
        private $__window_ready = "";
            
/*
 * Get data of private var on window Load
 * 
 */
        public function getwindowLoad(){
                return $this->__window_load;
            }
/*
 * Get data of private var on window Ready
 * 
 */
        public function getwindowReady(){
            return $this->__window_ready;
        }
/*
 * set Jquery code on Window Ready
 * 
 */
        public function setwindowReady($js_code){
                if(strlen($js_code) != 0){
                    $this->__window_ready .= $js_code;
                    return true;
                }else{
                    return false;
                }
...
/*
 * set Jquery code on Window Load
 * 
 */
            public function setwindowLoad($js_code){
                if(strlen($js_code) != 0){
                    $this->__window_load .= $js_code;
                    return true;
                }else{
                    return false;
                }
